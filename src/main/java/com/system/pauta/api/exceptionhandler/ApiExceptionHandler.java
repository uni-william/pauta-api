...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = String.format("A Url %s, que você tentou acessar, é inexistente", ex.getRequestURL());
	...
	public ResponseEntity<?> handleEntidadeNaoEncontrada(PautaNaoEncontradaException ex, WebRequest request) {
